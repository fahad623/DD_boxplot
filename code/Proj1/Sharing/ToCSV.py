...
def calc_probas(row, row2):
    ...
    return p0/sum, p1/sum, p2/sum, p3/sum, p4/sum
...
def to_csv():
    with open(location_input_file) as infile, open(location_output_file, "wb") as outfile, open(location_input_operating) as infile2:
        ...
        writer.writerow(['Sharing__Leadership & Management',
                         'Sharing__NO_LABEL','Sharing__School Reported',
                         'Sharing__School on Central Budgets',	'Sharing__Shared Services'])
